<template>
  <div style="display: flex; flex-flow: row wrap">
    <div class="row">
      ...
      <div class="col-10">
        <div v-for="appGroup in this.apps.value" :key="appGroup.group_name" :value="appGroup.group_name"
          ...
          <v-dialog v-model="dialog" width="500">
            <v-card>
              ...
              <v-card-text class="text-left">
                <p></p>
                <p>
                  <a style="color: #176bae; font-size: 15px; font-weight: bold">Shortname</a>
                  <br />
                ...
                <p>
                  <a style="color: #176bae; font-size: 15px; font-weight: bold">Docker Versions</a>
                </p>
                ...
                <br />
                <p>
                  <a style="color: #176bae; font-size: 15px; font-weight: bold">Version</a>
                  <br />
                  <a v-if="allVersions[allVersionIndex]">{{
                ...
                <p>
                  <a style="color: #176bae; font-size: 15px; font-weight: bold">Catalogue URL</a>
                  <br />
                  <a v-if="allVersions[allVersionIndex]">{{
                ...
                <p>
                  <a style="color: #176bae; font-size: 15px; font-weight: bold">Application URL</a>
                  <br />
                  <a v-if="allVersions[allVersionIndex]">{{
                ...
                <p>
                  <a style="color: #176bae; font-size: 15px; font-weight: bold">Tags</a>
                  <br />
                  <a v-if="allVersions[allVersionIndex]">{{
                ...
                <p>
                  <a style="color: #176bae; font-size: 15px; font-weight: bold">Description</a>
                  <br />
                  <a v-if="allVersions[allVersionIndex]">{{
          ...
          if (this.searchbar == "") {
            ...
            for (let group = 0; group < allApps.length; group++) {
              for (
                ...
                if (allApps[group].group_members[groupmember].app_dispay_name.toLowerCase().includes(this.searchbar.toLowerCase()) ||
                  allApps[group].group_members[groupmember].app_name.toLowerCase().includes(this.searchbar.toLowerCase()) ||
                  allApps[group].group_members[groupmember].short_description.toLowerCase().includes(this.searchbar.toLowerCase())) {
                  console.log(
